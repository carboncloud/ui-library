...
var $author$project$Button$Warn = {$: 'Warn'};
...
var $author$project$Color$Internal$toHexString = function (_v0) {
	var red = _v0.red;
	var green = _v0.green;
	var blue = _v0.blue;
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Color$Internal$toHexString(color))
						]))
				]));
	});
...
var $author$project$Explorer$Helpers$colorSwatchGroup = $rtfeldman$elm_css$Html$Styled$div(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
...
var $kalutheo$elm_ui_explorer$UIExplorer$Logo = function (a) {
	return {$: 'Logo', a: a};
};
var $kalutheo$elm_ui_explorer$UIExplorer$logoFromHtml = function (logo) {
	return $kalutheo$elm_ui_explorer$UIExplorer$Logo(
...
var $kalutheo$elm_ui_explorer$UIExplorer$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $kalutheo$elm_ui_explorer$UIExplorer$UrlChange = function (a) {
...
var $kalutheo$elm_ui_explorer$UIExplorer$ColorMode$Light = {$: 'Light'};
var $kalutheo$elm_ui_explorer$UIExplorer$getStoryIdFromStories = function (_v0) {
	var s = _v0.a;
	return s;
};
var $kalutheo$elm_ui_explorer$UIExplorer$getDefaultUrlFromCategories = function (categories) {
	return A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
					...
					A2(
						...
						function (_v3) {
							...
							return maybeDefaultStr(
								A2(
									$elm$core$Maybe$map,
									$kalutheo$elm_ui_explorer$UIExplorer$getStoryIdFromStories,
...
var $kalutheo$elm_ui_explorer$UIExplorer$fragmentToArray = function (fragment) {
	return A2(
		$elm$core$Array$map,
		A2(
			$elm$core$Basics$composeR,
...
var $kalutheo$elm_ui_explorer$UIExplorer$getFragmentSegmentByIndex = F2(
	function (fragment, index) {
		return A2(
			$elm$core$Array$get,
			index,
			$kalutheo$elm_ui_explorer$UIExplorer$fragmentToArray(
				A2($elm$core$Maybe$withDefault, '', fragment)));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$getSelectedCategoryfromPath = function (_v0) {
	var fragment = _v0.fragment;
	return A2($kalutheo$elm_ui_explorer$UIExplorer$getFragmentSegmentByIndex, fragment, 0);
};
var $kalutheo$elm_ui_explorer$UIExplorer$getSelectedStoryfromPath = function (_v0) {
	var fragment = _v0.fragment;
	return A2($kalutheo$elm_ui_explorer$UIExplorer$getFragmentSegmentByIndex, fragment, 2);
};
var $kalutheo$elm_ui_explorer$UIExplorer$getSelectedUIfromPath = function (_v0) {
	var fragment = _v0.fragment;
	return A2($kalutheo$elm_ui_explorer$UIExplorer$getFragmentSegmentByIndex, fragment, 1);
};
...
var $kalutheo$elm_ui_explorer$UIExplorer$init = F5(
	function (customModel, categories, _v0, url, key) {
		var selectedUIId = $kalutheo$elm_ui_explorer$UIExplorer$getSelectedUIfromPath(url);
		var selectedStoryId = $kalutheo$elm_ui_explorer$UIExplorer$getSelectedStoryfromPath(url);
		var selectedCategory = $kalutheo$elm_ui_explorer$UIExplorer$getSelectedCategoryfromPath(url);
		var firstUrl = A2(
			$elm$core$Maybe$withDefault,
			$kalutheo$elm_ui_explorer$UIExplorer$getDefaultUrlFromCategories(categories),
			A4(
				$elm$core$Maybe$map3,
				F3(
				...
				selectedStoryId));
		return _Utils_Tuple2(
			{categories: categories, colorMode: $kalutheo$elm_ui_explorer$UIExplorer$ColorMode$Light, customModel: customModel, key: key, mobileMenuIsOpen: false, selectedCategory: selectedCategory, selectedStoryId: selectedStoryId, selectedUIId: selectedUIId, url: url},
			A2($elm$browser$Browser$Navigation$pushUrl, key, firstUrl));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$ColorMode$Dark = {$: 'Dark'};
...
var $kalutheo$elm_ui_explorer$UIExplorer$makeStoryUrl = F2(
...
var $kalutheo$elm_ui_explorer$UIExplorer$update = F3(
	function (config, msg, model) {
		switch (msg.$) {
			...
			case 'ExternalMsg':
				...
				return _Utils_Tuple2(
					newModel,
					A2($elm$core$Platform$Cmd$map, $kalutheo$elm_ui_explorer$UIExplorer$ExternalMsg, subCmd));
			case 'SelectStory':
				var storyId = msg.a;
				var _v2 = A2($kalutheo$elm_ui_explorer$UIExplorer$makeStoryUrl, model, storyId);
				if (_v2.$ === 'Just') {
					var url = _v2.a;
					return _Utils_Tuple2(
						model,
			...
			case 'UrlChange':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedCategory: $kalutheo$elm_ui_explorer$UIExplorer$getSelectedCategoryfromPath(location),
							selectedStoryId: $kalutheo$elm_ui_explorer$UIExplorer$getSelectedStoryfromPath(location),
							selectedUIId: $kalutheo$elm_ui_explorer$UIExplorer$getSelectedUIfromPath(location),
							url: location
						}),
					$elm$core$Platform$Cmd$none);
			case 'LinkClicked':
			...
			default:
				var colorMode = function () {
					...
					if (_v5.$ === 'Dark') {
						return $kalutheo$elm_ui_explorer$UIExplorer$ColorMode$Light;
					} else {
						return $kalutheo$elm_ui_explorer$UIExplorer$ColorMode$Dark;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
...
var $kalutheo$elm_ui_explorer$UIExplorer$darkTheme = {
...
var $kalutheo$elm_ui_explorer$UIExplorer$lightTheme = {
...
var $kalutheo$elm_ui_explorer$UIExplorer$getTheme = function (colorMode) {
	if (colorMode.$ === 'Dark') {
		return $kalutheo$elm_ui_explorer$UIExplorer$darkTheme;
	} else {
		return $kalutheo$elm_ui_explorer$UIExplorer$lightTheme;
	}
};
var $kalutheo$elm_ui_explorer$UIExplorer$oneQuarter = 'w-1/4';
var $kalutheo$elm_ui_explorer$UIExplorer$toClassName = function (list) {
...
var $kalutheo$elm_ui_explorer$UIExplorer$filterSelectedUI = F2(
	function (_v0, model) {
		var ui = _v0.a;
		return A2(
			$elm$core$Maybe$withDefault,
...
var $kalutheo$elm_ui_explorer$UIExplorer$getUIListFromCategories = function (_v0) {
	var _v1 = _v0.a;
	var categories = _v1.b;
	return categories;
};
var $kalutheo$elm_ui_explorer$UIExplorer$SelectStory = function (a) {
...
var $kalutheo$elm_ui_explorer$UIExplorer$hover = function (className) {
	return 'hover:uie-' + className;
};
var $kalutheo$elm_ui_explorer$UIExplorer$renderStory = F4(
	function (_v0, index, _v1, _v2) {
		...
		var liClass = isActive ? A2(
			...
			_List_fromArray(
				[
					...
					storyMenu.text,
					'cursor-pointer',
					$kalutheo$elm_ui_explorer$UIExplorer$hover(storyMenu.hoverBg)
				]));
		...
		return A2(
			...
			_List_fromArray(
				[
					$kalutheo$elm_ui_explorer$UIExplorer$toClassName(liClass),
					$elm$html$Html$Events$onClick(
					$kalutheo$elm_ui_explorer$UIExplorer$SelectStory(id)),
					buttonClass
				]),
			_List_fromArray(
				[
...
var $kalutheo$elm_ui_explorer$UIExplorer$renderStories = F4(
	function (config, stories, viewConfig, model) {
		var theme = $kalutheo$elm_ui_explorer$UIExplorer$getTheme(model.colorMode);
		var menu = A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$kalutheo$elm_ui_explorer$UIExplorer$toClassName(
						_List_fromArray(
				...
				A2(
					...
					function (index) {
						return A3($kalutheo$elm_ui_explorer$UIExplorer$renderStory, theme, index, viewConfig);
					},
					stories)));
		var _v0 = viewConfig;
		...
		var content = function () {
			...
			if (_v1.$ === 'Just') {
				...
				return A2(
					$elm$html$Html$map,
					$kalutheo$elm_ui_explorer$UIExplorer$ExternalMsg,
					story(model));
			} else {
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewContent = F2(
	function (config, model) {
		...
		var filteredUIs = A2(
			$elm$core$List$filter,
			function (ui) {
				return A2($kalutheo$elm_ui_explorer$UIExplorer$filterSelectedUI, ui, model);
			},
			A3(
				$elm$core$List$foldr,
				$elm$core$Basics$append,
				_List_Nil,
				A2($elm$core$List$map, $kalutheo$elm_ui_explorer$UIExplorer$getUIListFromCategories, model.categories)));
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$kalutheo$elm_ui_explorer$UIExplorer$toClassName(_List_Nil)
							]),
						_List_fromArray(
							[
								A2(
						...
						A2(
							...
							function (_v0) {
								...
								return A2(
									config.viewEnhancer,
									model,
									A4($kalutheo$elm_ui_explorer$UIExplorer$renderStories, config, s.viewStories, viewConfig, model));
							},
							filteredUIs))),
					A2(
...
var $kalutheo$elm_ui_explorer$UIExplorer$styleHeader = {
...
var $kalutheo$elm_ui_explorer$UIExplorer$ColorModeToggled = {$: 'ColorModeToggled'};
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewToggleDarkMode = F3(
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						A2(
							$elm$core$List$cons,
							$elm$html$Html$Events$onClick($kalutheo$elm_ui_explorer$UIExplorer$ColorModeToggled),
							styles)),
					_List_fromArray(
						[
							A2(
...
var $kalutheo$elm_ui_explorer$UIExplorer$MobileMenuToggled = {$: 'MobileMenuToggled'};
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewToggleMobileMenu = F2(
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						A2(
							$elm$core$List$cons,
							$elm$html$Html$Events$onClick($kalutheo$elm_ui_explorer$UIExplorer$MobileMenuToggled),
							styles)),
					_List_fromArray(
						[
							A2(
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewActionButtons = F3(
	function (colorMode, theme, titleStyles) {
		return A2(
			...
			_List_fromArray(
				[
					A3($kalutheo$elm_ui_explorer$UIExplorer$viewToggleDarkMode, colorMode, theme, titleStyles),
					A2($kalutheo$elm_ui_explorer$UIExplorer$viewToggleMobileMenu, theme, titleStyles)
				]));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$viewHeader = F3(
		...
		if (customHeader.$ === 'Just') {
			...
			return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$kalutheo$elm_ui_explorer$UIExplorer$toClassName($kalutheo$elm_ui_explorer$UIExplorer$styleHeader.header),
							heightStyle
						])),
				_List_fromArray(
					[
						...
						A3($kalutheo$elm_ui_explorer$UIExplorer$viewActionButtons, colorMode, theme, titleStyles)
					]));
		} else {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						A3($kalutheo$elm_ui_explorer$UIExplorer$viewActionButtons, colorMode, theme, _List_Nil)
					]));
		}
	});
var $elm$html$Html$aside = _VirtualDom_node('aside');
var $kalutheo$elm_ui_explorer$UIExplorer$styleMenuCategoryLink = _List_fromArray(
	['text-grey-darkest', 'font-bold', 'w-full', 'flex', 'cursor-default', 'pl-4', 'pb-2', 'pt-2', 'text-sm', 'no-underline']);
var $kalutheo$elm_ui_explorer$UIExplorer$styleMenuItem = F2(
	function (_v0, isSelected) {
		...
		var defaultClass = _List_fromArray(
			[
				...
				'text-xs',
				'no-underline',
				$kalutheo$elm_ui_explorer$UIExplorer$hover(menu.hoverBg),
				$kalutheo$elm_ui_explorer$UIExplorer$hover(menu.hoverText)
			]);
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewMenuItem = F4(
	function (theme, cat, selectedUIId, _v0) {
		...
		var isSelected = A2(
			...
			A2(
				...
				selectedUIId));
		var linkClass = A2($kalutheo$elm_ui_explorer$UIExplorer$styleMenuItem, theme, isSelected);
		var defaultLink = function () {
			var _v1 = $elm$core$List$head(ui.viewStories);
			if (_v1.$ === 'Just') {
				var story = _v1.a;
				return '#' + (cat + ('/' + (ui.id + ('/' + $kalutheo$elm_ui_explorer$UIExplorer$getStoryIdFromStories(story)))));
			} else {
				return '#' + (cat + ('/' + ui.id));
			}
		}();
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$kalutheo$elm_ui_explorer$UIExplorer$toClassName(linkClass),
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewMenuCategory = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$kalutheo$elm_ui_explorer$UIExplorer$toClassName($kalutheo$elm_ui_explorer$UIExplorer$styleMenuCategoryLink)
						]),
					_List_fromArray(
						[
							A2(
					...
					A2(
						$elm$core$List$map,
						A3($kalutheo$elm_ui_explorer$UIExplorer$viewMenuItem, theme, title, selectedUIId),
						categories))
				]));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$viewMenu = F3(
	function (theme, categories, config) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				A2($kalutheo$elm_ui_explorer$UIExplorer$viewMenuCategory, theme, config),
				categories));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$viewSidebar = function (model) {
	var viewConfig = {selectedStoryId: model.selectedStoryId, selectedUIId: model.selectedUIId};
	var theme = $kalutheo$elm_ui_explorer$UIExplorer$getTheme(model.colorMode);
	return A3($kalutheo$elm_ui_explorer$UIExplorer$viewMenu, theme, model.categories, viewConfig);
};
var $kalutheo$elm_ui_explorer$UIExplorer$view = F2(
	function (config, model) {
		var theme = $kalutheo$elm_ui_explorer$UIExplorer$getTheme(model.colorMode);
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					A3($kalutheo$elm_ui_explorer$UIExplorer$viewHeader, model.colorMode, theme, config.customHeader),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									$kalutheo$elm_ui_explorer$UIExplorer$toClassName(
									_List_fromArray(
										[$kalutheo$elm_ui_explorer$UIExplorer$oneQuarter, theme.sidebar.background, theme.sidebar.borderColor, 'overflow-scroll', 'sm:hidden'])),
									A2($elm$html$Html$Attributes$style, 'height', 'calc(100vh - 86px)'),
									$elm$html$Html$Attributes$class('uie-hidden md:uie-block')
								]),
							_List_fromArray(
								[
									$kalutheo$elm_ui_explorer$UIExplorer$viewSidebar(model)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									A2($kalutheo$elm_ui_explorer$UIExplorer$viewContent, config, model)
								]))
						]))
				]));
	});
var $kalutheo$elm_ui_explorer$UIExplorer$viewMobileMenu = F2(
...
var $kalutheo$elm_ui_explorer$UIExplorer$viewMobileOverlay = function (isOpen) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $kalutheo$elm_ui_explorer$UIExplorer$app = F2(
	function (config, categories) {
		return $elm$browser$Browser$application(
			{
				init: A2($kalutheo$elm_ui_explorer$UIExplorer$init, config.customModel, categories),
				onUrlChange: $kalutheo$elm_ui_explorer$UIExplorer$UrlChange,
				onUrlRequest: $kalutheo$elm_ui_explorer$UIExplorer$LinkClicked,
				...
				update: $kalutheo$elm_ui_explorer$UIExplorer$update(config),
				view: function (model) {
					return {
						body: _List_fromArray(
							[
								$kalutheo$elm_ui_explorer$UIExplorer$viewMobileOverlay(model.mobileMenuIsOpen),
								A2($kalutheo$elm_ui_explorer$UIExplorer$viewMobileMenu, model, model.mobileMenuIsOpen),
								A2($kalutheo$elm_ui_explorer$UIExplorer$view, config, model)
							]),
						title: 'Storybook Elm'
					};
				}
...
var $kalutheo$elm_ui_explorer$UIExplorer$UICategoryType = function (a) {
	return {$: 'UICategoryType', a: a};
};
var $kalutheo$elm_ui_explorer$UIExplorer$createCategories = _List_Nil;
var $kalutheo$elm_ui_explorer$UIExplorer$fromUIList = function (uiList) {
	return A2(
		$elm$core$List$append,
		_List_fromArray(
			[
				$kalutheo$elm_ui_explorer$UIExplorer$UICategoryType(
				_Utils_Tuple2('Default', uiList))
			]),
		$kalutheo$elm_ui_explorer$UIExplorer$createCategories);
};
var $kalutheo$elm_ui_explorer$UIExplorer$explore = F2(
	function (config, uiList) {
		return A2(
			$kalutheo$elm_ui_explorer$UIExplorer$app,
			config,
...
var $tesk9$accessible_html_with_css$Accessibility$Styled$Role$button = $tesk9$accessible_html_with_css$Accessibility$Styled$Utils$role($tesk9$accessible_html_with_css$Accessibility$Styled$Utils$Button);
...
var $tesk9$accessible_html_with_css$Accessibility$Styled$img = F2(
	function (alt_, attributes) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$img,
			A2(
				$elm$core$List$cons,
				$rtfeldman$elm_css$Html$Styled$Attributes$alt(alt_),
...
var $author$project$Shadow$Px = function (a) {
	return {$: 'Px', a: a};
};
...
var $author$project$Shadow$toString = function (_v0) {
	var offsetX = _v0.offsetX;
	var offsetY = _v0.offsetY;
	var blurRadius = _v0.blurRadius;
	var spreadRadius = _v0.spreadRadius;
	var color = _v0.color;
	var fromCssColor = function (_v2) {
		var red = _v2.red;
		var green = _v2.green;
		var blue = _v2.blue;
		var alpha = _v2.alpha;
	...
	var cssPixelVal = function (length) {
		if (!length.a) {
			return '0';
		} else {
			var v = length.a;
			return $elm$core$String$fromInt(v) + 'px';
		}
	};
	return A2(
		$elm$core$String$join,
...
var $author$project$Shadow$toStyle = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			$rtfeldman$elm_css$Css$property('box-shadow'),
			$elm$core$String$join(', ')),
		$elm$core$List$map($author$project$Shadow$toString)),
	$mgold$elm_nonempty_list$List$Nonempty$toList);
var $author$project$Shadow$shadow = function (size) {
	return $author$project$Shadow$toStyle(
		function () {
			if (size.$ === 'Large') {
				return A2(
					$mgold$elm_nonempty_list$List$Nonempty$Nonempty,
					{
						blurRadius: $author$project$Shadow$Px(15),
						color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.05),
						offsetX: $author$project$Shadow$Px(0),
						offsetY: $author$project$Shadow$Px(10),
						spreadRadius: $author$project$Shadow$Px(7)
					},
					_List_fromArray(
						[
							{
							blurRadius: $author$project$Shadow$Px(6),
							color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.05),
							offsetX: $author$project$Shadow$Px(0),
							offsetY: $author$project$Shadow$Px(4),
							spreadRadius: $author$project$Shadow$Px(-2)
						}
						]));
			} else {
				return A2(
					$mgold$elm_nonempty_list$List$Nonempty$Nonempty,
					{
						blurRadius: $author$project$Shadow$Px(1),
						color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.11),
						offsetX: $author$project$Shadow$Px(0),
						offsetY: $author$project$Shadow$Px(1),
						spreadRadius: $author$project$Shadow$Px(0)
					},
					_List_fromArray(
						[
							{
							blurRadius: $author$project$Shadow$Px(2),
							color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.11),
							offsetX: $author$project$Shadow$Px(0),
							offsetY: $author$project$Shadow$Px(2),
							spreadRadius: $author$project$Shadow$Px(0)
						},
							{
							blurRadius: $author$project$Shadow$Px(4),
							color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.11),
							offsetX: $author$project$Shadow$Px(0),
							offsetY: $author$project$Shadow$Px(4),
							spreadRadius: $author$project$Shadow$Px(0)
							...
							{
							blurRadius: $author$project$Shadow$Px(8),
							color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.11),
							offsetX: $author$project$Shadow$Px(0),
							offsetY: $author$project$Shadow$Px(6),
							spreadRadius: $author$project$Shadow$Px(0)
						},
							{
							blurRadius: $author$project$Shadow$Px(16),
							color: A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.11),
							offsetX: $author$project$Shadow$Px(0),
							offsetY: $author$project$Shadow$Px(8),
							spreadRadius: $author$project$Shadow$Px(0)
						}
						]));
			}
...
var $kalutheo$elm_ui_explorer$UIExplorer$storiesOf = F2(
	function (id, stories) {
...
var $author$project$Explorer$Helpers$toneGroup = function (name) {
	return $elm$core$List$map(
		function (_v0) {
			...
			var tone = _v0.b;
			return A2(
				$author$project$Explorer$Helpers$colorSwatch,
				name + ('-' + $elm$core$String$fromInt(tone)),
				color);
		});
};
var $author$project$Explorer$main = A2(
	$kalutheo$elm_ui_explorer$UIExplorer$explore,
	$author$project$Explorer$config,
	_List_fromArray(
		[
			A2(
